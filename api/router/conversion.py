...
from api.models.schemas import UniResponse
from api.service.task_manager import create_task
from api.utils.constants import SUPPORTED_FORMATS
...
from api.dr_worker import dramatiq_send_convert
...
from api.models.schemas import TaskStatusResponse,Meta
...
async def convert_cad_to_gcode(
    ...
    **推荐使用方式:**
    ...
    import requests
    from urllib.parse import urlparse
    from api.service.gcode import cad_to_gcode, is_cad_file
    ...
    try:
        ...
        # 5. 准备G-code转换参数
        # 先获取材料和操作类型的预设参数
        from api.service.gcode import get_machining_presets
