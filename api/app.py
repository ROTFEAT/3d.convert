...
# 导入路由
from api.router import common, conversion, worker, tasks, r2
from api.service.task_manager import redis_client

# 添加调试功能
from api.utils.debug import print_environment_variables
...
def update_task_status(task_id, status, **kwargs):
    ...
    try:
        ...
        return False
from api.service.task_manager import clear_redis
