...
from service.task_manager import update_task_status,get_task_status
...
async def get_next_task_api():
    ...
    - 任务数据或空对象
    """
    from service.task_manager import get_next_task
...
from service.worker import claim_task_with_lua
